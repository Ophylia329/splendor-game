...
LAYOUT = {
    'title': {'y': 40},
    'gem_area': {'x': 20, 'y': 100, 'width': 180},  # 恢复y=100，标题位置不变
    'card_area': {'x': 220, 'y': 100, 'width': 1200, 'height': 550},  # 高度从600改为550
    'noble_area': {'x': 1300, 'y': 100, 'width': 600},  # x从1450改为1300（往左150），宽度增加到600
    'player_area': {'y': 670, 'height': 380}  # y从720改为670（上移），高度增加到380
}

# 卡牌尺寸（缩小以避免被玩家区域遮挡）
CARD_WIDTH = 120  # 从140改为120
CARD_HEIGHT = 175  # 从200改为175
CARD_MARGIN = 12
